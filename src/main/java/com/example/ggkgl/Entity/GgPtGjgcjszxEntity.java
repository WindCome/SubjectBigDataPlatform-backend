...
@Entity
@Table(name = "GG_PT_GJGCJSZX", schema = "basic_data", catalog = "")
public class GgPtGjgcjszxEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgPtGjgcjszxEntity that = (GgPtGjgcjszxEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, sysmc, pdsj, jszt, cydws, xxmc, xxdm, sysmcZz);
    }
}
