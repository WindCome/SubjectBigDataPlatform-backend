...
@Entity
@Table(name = "GG_ZJ_JYBQNJS", schema = "basic_data", catalog = "")
public class GgZjJybqnjsEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgZjJybqnjsEntity that = (GgZjJybqnjsEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, xm, cydws, xmmc, xxdm, xklb, pdsj, lb);
    }
}
