...
@Entity
@Table(name = "GG_ZJ_GJJJXMS", schema = "basic_data", catalog = "")
public class GgZjGjjjxmsEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgZjGjjjxmsEntity that = (GgZjGjjjxmsEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, xm, cydws, xxmc, pdsj, pc, bz, xxdm, lb);
    }
}
