...
@Entity
@Table(name = "GG_PT_GFKJZDSYS", schema = "basic_data", catalog = "")
public class GgPtGfkjzdsysEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgPtGfkjzdsysEntity that = (GgPtGfkjzdsysEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, sysmc, cydws, xxmc, xxdm, sysmcZz, platformCategory);
    }
}
