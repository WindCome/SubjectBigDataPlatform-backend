...
@Entity
@Table(name = "GG_HJ_LXLYKJJ", schema = "basic_data", catalog = "")
public class GgHjLxlykjjEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgHjLxlykjjEntity that = (GgHjLxlykjjEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, hjbh, xmmc, wcr, hjdj, pdsj, cydws, xxmc, xxdm, xmmcZz);
    }
}
