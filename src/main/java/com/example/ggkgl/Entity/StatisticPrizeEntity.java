...
@Entity
@Table(name = "statistic_prize", schema = "basic_data", catalog = "")
public class StatisticPrizeEntity {
    private String id;
    private String name;
    ...
    public boolean equals(Object o) {
        ...
        StatisticPrizeEntity that = (StatisticPrizeEntity) o;
        return Objects.equals(id, that.id) &&
                Objects.equals(name, that.name) &&
                Objects.equals(prizeCategory, that.prizeCategory) &&
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, name, prizeCategory, unitId, disciplineId, evaluateTime);
    }
}
