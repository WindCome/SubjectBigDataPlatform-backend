...
@Entity
@Table(name = "GG_HJ_HXJSKJJ", schema = "basic_data", catalog = "")
public class GgHjHxjskjjEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgHjHxjskjjEntity that = (GgHjHxjskjjEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, xmmc, wcr, hjdj, pdsj, cydws, xxmc, xxdm, xmmcZz);
    }
}
