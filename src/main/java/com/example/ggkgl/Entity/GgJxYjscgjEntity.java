...
@Entity
@Table(name = "GG_JX_YJSCGJ", schema = "basic_data", catalog = "")
public class GgJxYjscgjEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgJxYjscgjEntity that = (GgJxYjscgjEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, hjdj, xmmc, wcr, hjlb, pdsj, cydws, xxmc, xxdm, xmmcZz);
    }
}
