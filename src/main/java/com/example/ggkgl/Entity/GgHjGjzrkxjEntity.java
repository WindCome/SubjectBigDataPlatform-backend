...
@Entity
@Table(name = "GG_HJ_GJZRKXJ", schema = "basic_data", catalog = "")
public class GgHjGjzrkxjEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgHjGjzrkxjEntity that = (GgHjGjzrkxjEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, zsbh, xmmc, wcr, tjdw, pdsj, hjdj, cydws, xxmc, xxdm, xmmcZz);
    }
}
