...
@Entity
@Table(name = "GG_HJ_ZHZYYXHKJJ", schema = "basic_data", catalog = "")
public class GgHjZhzyyxhkjjEntity {
    private String id;
    ...
    public boolean equals(Object o) {
        ...
        GgHjZhzyyxhkjjEntity that = (GgHjZhzyyxhkjjEntity) o;
    ...
    public int hashCode() {
        ...
        return Objects.hash(id, modifyUserId, modifyTime, seqNo, pdsj, hjdj, zsbh, xmbh, xmmc, wcr, cydws, xxmc, xxdm, xmmcZz);
    }
}
